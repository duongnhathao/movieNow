...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('/images') }}/ico/icon_web.ico">
    <!-- Bootstrap CSS -->
...
<div class="na">
    <nav class="navbar navbar-expand-xl navbar-light bg-custom">
        ...
        <img src="{{asset("images\logo\logo2.png")}}" style="height: 40px; width: auto;" alt="">
        </a>
...
{{--            </form>--}}
    ...
    <div class="overlay" id="onover"></div>
