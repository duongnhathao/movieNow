			...
			<header class="site-header">
				<div class="container">
					...
					<div class="main-navigation">
						...
						<ul class="menu">
							<li class="menu-item"><a href="index.blade.php">Home</a></li>
							<li class="menu-item"><a href="about.blade.php">About</a></li>
							<li class="menu-item"><a href="review.blade.php">Movie reviews</a></li>
							<li class="menu-item"><a href="joinus.blade.php">Join us</a></li>
							<li class="menu-item current-menu-item"><a href="contact.blade.php">Contact</a></li>
						</ul> <!-- .menu -->
